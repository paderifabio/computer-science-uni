...
public class AppelloDiGennaio01 {

  /**
   * ESERCIZIO 1 (Massimo 7 punti -- da consegnare elettronicamente). Scrivere
   * un metodo iterativo exUno con le seguenti caratteristiche: 
   * a) exUno ha un parametro formale a di tipo (reference ad un) array di booleani; 
   * b) il metodo riorganizza l'array a in modo che i valori true siano spostati
   *    nella sua parte destra, cioe' nelle posizioni con indice in valore piu' alto. 
   *    In termini formali: 
   *    nell'array riorganizzato, per ogni coppia di posizioni i e j,
   *    se i<j e a[j]==false, allora anche a[i]==false; 
   ...
   *
   * ESEMPI. 
   * Se b-->{false, true, true, false, true} allora exUno(b) riorganizza l'array 
   * in {false, false, true, true, true}.
   *
   * DOVE SCRIVERE exUno. 
  ...
  /** ATTENZIONE!
   *  Metodo privato che deve essere usato dalla soluzione dell'ESERCIZIO 2.
   */
   ...
   *    2) l'indice che guida la ricorsione DECRESCA durante le chiamate ricorsive.
   * 
   * ESEMPI.
