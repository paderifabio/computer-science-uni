...
public class AppelloDiGennaio03 {
   ...
   * b) il metodo riorganizza l'array a in modo che i valori pari siano 
   *    spostati nella sua parte destra, cioe' nelle posizioni con indice in valore piu' alto.
   *    In termini formali: 
   *    nell'array riorganizzato, per ogni coppia di posizioni i e j,
   *    se i<j e a[i] e' pari, allora anche a[j] e' pari;
   ...
   *
   * ESEMPI. 
   * Se b-->{0, 2, 5, 1, 4} allora exUno(b) riorganizza l'array in {0, 1, 5, 4, 2} oppure 
   * {0, 1, 5, 2, 4} (il risultato dipende da scelte algoritmiche fatte).
   * 
   * DOVE SCRIVERE exUno. 
