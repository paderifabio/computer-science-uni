...
public class EsameC1Del150122 {
	 ...
	 * (ii) restituisca true se esiste almeno un elemento in a strettamente maggiore di ogni 
	 * elemento di b, false altrimenti.
	 * 
	 * ESEMPI.
	 * Con a == {3,4,1} e b == {1,2,3} il risultato e' true perche'
	 * 4 e' maggiore di tutti gli elementi di b. 
	 * Con a == {3,0,1} e b == {1,2,3} il risultato e' false perche'
	 * nessun elemento di a è strettamente maggiore di tutti gli elementi di b. 
	 */
	 ...
	 * (ii) alteri a in modo da scambiare ogni elemento di posizione dispari con
	 ...
	 * 
	 * ESEMPIO.
	 * Con a == {1,2,3,4,5,6} il risultato e' {1,3,2,5,4,6}. 
	 * Con a == {1,2,3,4,5} il risultato e' {1,3,2,5,4}. 
	 */
	 ...
	 *    false||a[0] &&...&& a[i-1] == r
	 * dimostrare che il seguente metodo restituisce in r la congiunzione 
	 * degli elementi in a. 
	 */

	public static boolean cong(boolean[] a) {
		boolean r = true;
		int i = 0;
		while (i < a.length) {
			r = r && a[i];
