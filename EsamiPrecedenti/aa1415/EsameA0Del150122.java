...
public class EsameA0Del150122 {
	 ...
	 * sia maggiore del precedente, ammesso che il precedente esista e 
	 * false altrimenti.
	 * 
	 * ESEMPI.
	 * Con m == {{3,4,1},{1,2,3},{3,4,2}} il risultato e' true perche'
	 * la seconda riga soddisfa la condizione. 
	 * Con m == {{3,4,1},{3,2,1},{3,4,2}} il risultato e' false perche'
	 ...
	 * strettamente maggiore di v ed in posizione pari.
